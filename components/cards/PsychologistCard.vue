<script setup>
import PlaySvgIcon from "~/components/cards/PlaySvgIcon.vue";
...
<template>
  <div class="border shadow p-3 text-center">
    ...
    <div class="flex justify-center gap-2 mt-3 px-2 flex-wrap">
      ...
      <button class="w-[90px] text-center px-3 text-lg h-[50px] bg-[#B37B37] rounded leading-none text-[#ECDFB5]">11.30am</button>
      <button class="w-[90px] text-center px-3 text-lg h-[50px] bg-[#B37B37] rounded leading-none text-[#ECDFB5]">10am</button>
      <button class="w-[90px] text-center px-3 text-lg h-[50px] bg-[#B37B37] rounded leading-none text-[#ECDFB5]">10am</button>
